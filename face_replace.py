...
def replaceFaces(imagePath, replacementPath, cascPath, outDir=None):
    ...
    dirname = outDir if outDir is not None else os.path.dirname(imagePath)
    newImage = os.path.join(dirname, name + ".merged" + ext)
...
if __name__ == "__main__":
    ...
    cascPath = sys.argv[3]
    replaceFaces(imagePath, replacementPath, cascPath)
